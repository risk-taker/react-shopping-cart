...
const Cart = () => {
    ...
    useEffect(() => {
        ...
        fetch('/api/products/cart-items', {
            ...
            headers: {
              ...
              body: JSON.stringify({ ids: Object.keys(cart.items)}) //Object.keys convert object into array of items.
        }).then(res => res.json())
        .then(products => {
    ...
    const getQty = (productId) => {
        return cart.items[productId]; //cart.items[] return value.
    }
    ...
    const handleDelete = (productId) => {
        ...
        setCart(_cart);
        const updatedProductsList = products.filter((product) => product._id !== productId); //here false wla can't retun product but true wla return product.
